...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="aminoglycoside-hartford-nomogram", description="Aminoglycoside Hartford Nomogram")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  AMINOGLYCOSIDE HARTFORD NOMOGRAM")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Aminoglycoside Hartford Nomogram Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Aminoglycoside Hartford Nomogram API server on http://{args.host}:{args.port}")
