"""
FastAPI REST API Server for Aminoglycoside Hartford Nomogram.
"""
...
app = FastAPI(
    title="Aminoglycoside Hartford Nomogram API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "aminoglycoside-hartford-nomogram", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
